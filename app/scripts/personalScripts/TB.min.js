/*
 OpenTok JavaScript Library v2.0.18.1
 http://www.tokbox.com/
...
!function(k,c){var e=function(a){return document.getElementById(a)},g=k.OTHelpers;k.OTHelpers=e;e.noConflict=function(){e.noConflict=function(){return e};k.OTHelpers=g;return e};e.isEmpty=function(a){if(null===a||a===c)return!0;if(Array.isArray(a)||"string"===typeof a)return 0===a.length;for(var d in a)if(a.hasOwnProperty(d))return!1;return!0};e.isNone=function(a){return a===c||null===a};e.isObject=function(a){return a===Object(a)};e.isFunction=function(a){return"function"===typeof a};e.extend=function(){var a=
		...
		"x",{})}catch(a){e.canDefineProperty=!1}e.defineGetters=function(a,d,b){var f={};void 0===b&&(b=!1);for(var h in d)f[h]={get:d[h],enumerable:b};Object.defineProperties(a,f)};Object.create||(Object.create=function(a){function b(){}if(1<arguments.length)throw Error("Object.create implementation only accepts the first parameter.");b.prototype=a;return new b});e.setCookie=function(a,b){try{localStorage.setItem(a,b)}catch(d){var f=new Date;f.setTime(f.getTime()+31536E6);f="; expires\x3d"+f.toGMTString();
	document.cookie=a+"\x3d"+b+f+"; path\x3d/"}};e.getCookie=function(a){var b;try{return b=localStorage.getItem("opentok_client_id")}catch(d){a+="\x3d";for(var f=document.cookie.split(";"),h=0;h<f.length;h++){for(var c=f[h];" "==c.charAt(0);)c=c.substring(1,c.length);0===c.indexOf(a)&&(b=c.substring(a.length,c.length))}if(b)return b}return null};e.invert=function(a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[a[d]]=d);return b};var d={escape:{"\x26":"\x26amp;","\x3c":"\x26lt;","\x3e":"\x26gt;",'"':"\x26quot;",
	...
	"\u2029":"u2029"},l=/\\|'|\r|\n|\t|\u2028|\u2029/g;e.template=function(a,b,d){var c;d=e.defaults({},d,e.templateSettings);var g=RegExp([(d.escape||h).source,(d.interpolate||h).source,(d.evaluate||h).source].join("|")+"|$","g"),k=0,s="__p+\x3d'";a.replace(g,function(b,d,h,c,g){s+=a.slice(k,g).replace(l,function(a){return"\\"+f[a]});d&&(s+="'+\n((__t\x3d("+d+"))\x3d\x3dnull?'':OTHelpers.escape(__t))+\n'");h&&(s+="'+\n((__t\x3d("+h+"))\x3d\x3dnull?'':__t)+\n'");c&&(s+="';\n"+c+"\n__p+\x3d'");k=g+b.length;
	return b});s+="';\n";d.variable||(s="with(obj||{}){\n"+s+"}\n");s="var __t,__p\x3d'',__j\x3dArray.prototype.join,print\x3dfunction(){__p+\x3d__j.call(arguments,'');};\n"+s+"return __p;\n";try{c=new Function(d.variable||"obj",s)}catch(u){throw u.source=s,u;}if(b)return c(b);b=function(a){return c.call(this,a)};b.source="function("+(d.variable||"obj")+"){\n"+s+"}";return b}}(window);
...
(function(k,c,e){function g(a,b){var d=b||0,f=q;return f[a[d++]]+f[a[d++]]+f[a[d++]]+f[a[d++]]+"-"+f[a[d++]]+f[a[d++]]+"-"+f[a[d++]]+f[a[d++]]+"-"+f[a[d++]]+f[a[d++]]+"-"+f[a[d++]]+f[a[d++]]+f[a[d++]]+f[a[d++]]+f[a[d++]]+f[a[d++]]}function a(a,d,b){b=d&&b||0;"string"==typeof a&&(d="binary"==a?new l(16):null,a=null);a=a||{};a=a.random||(a.rng||f)();a[6]=a[6]&15|64;a[8]=a[8]&63|128;if(d)for(var h=0;16>h;h++)d[b+h]=a[h];return d||g(a)}var d,b=Array(16);e=function(){for(var a,d=0,d=0;16>d;d++)0===(d&
		3)&&(a=4294967296*Math.random()),b[d]=a>>>((d&3)<<3)&255;return b};if(k.crypto&&crypto.getRandomValues){var h=new Uint32Array(4);d=function(){crypto.getRandomValues(h);for(var a=0;16>a;a++)b[a]=h[a>>2]>>>8*(a&3)&255;return b}}var f=d||e,l="function"==typeof Buffer?Buffer:Array,q=[],m={};for(k=0;256>k;k++)q[k]=(k+256).toString(16).substr(1),m[q[k]]=k;a.v4=a;a.parse=function(a,d,b){var f=d&&b||0,h=0;d=d||[];for(a.toLowerCase().replace(/[0-9a-f]{2}/g,function(a){16>h&&(d[f+h++]=m[a])});16>h;)d[f+h++]=
		0;return d};a.unparse=g;a.BufferClass=l;a.mathRNG=e;a.whatwgRNG=d;c.uuid=a})(window,window.OTHelpers);
...
{},{data:f}))};c.getJSONP=function(a,b){var h,f=document.head||document.getElementsByTagName("head")[0],g,q=a,m=c.extend(b||{},{callbackParameter:"callback"}),k=function(){g&&(clearTimeout(g),g=null);h&&(h.onload=h.onreadystatechange=null,c.removeElement(h),h=e)},p=function(){if((!h.readyState||/loaded|complete/.test(h.readyState))&&g)clearTimeout(g),g=null};m.callbackName="jsonp_callback_"+ +new Date;this.jsonp_callbacks[m.callbackName]=function(a){k();m.success&&m.success(a)};q+=(/\?/.test(q)?"\x26":
		"?")+m.callbackParameter+"\x3d"+m.callbackName;h=c.createElement("script",{async:"async",src:q,onload:p,onreadystatechange:p});f.appendChild(h);g=setTimeout(function(){k();c.error("The JSONP request to "+q+" timed out after 30000ms.");m.error&&m.error("The JSONP request to "+a+" timed out after 30000ms.",q,m)},3E4)};var a=function(a,b,c){a.addEventListener("load",function(a){var d=a.target.status;200<=d&&300>d||304===d?b&&b.apply(null,arguments):c&&c(a)},!1);c&&a.addEventListener("error",c,!1)}})(window,
				window.OTHelpers);
...
(function(k){function c(a,d,b,c,f){d=d?parseInt(d,10):parseInt(OT.$.width(a.parentNode),10);b=b?parseInt(b,10):parseInt(OT.$.height(a.parentNode),10);if(!(0===d||0===b))if(c||(c=e),b=(d+0)/b,d={width:"100%",height:"100%",left:0,top:0},b>c?(c=100*(b/c),d.height=c+"%",d.top="-"+(c-100)/2+"%"):b<c&&(c=100*(c/b),d.width=c+"%",d.left="-"+(c-100)/2+"%"),OT.$.css(a,d),c=a.querySelector("video"))f?(f=a.offsetWidth,a=a.offsetHeight,d={width:a+"px",height:f+"px",marginTop:"",marginLeft:""},a=f-a,d.marginLeft=
		...
		a.width?a.width[1]:b.offsetWidth,a.height?a.height[1]:b.offsetHeight,l?l.aspectRatio:null)});q=OT.$.observeNodeOrChildNodeRemoval(b,function(a){l&&(a.some(function(a){return a===e||"VIDEO"===a.nodeName})&&(l.destroy(),l=null),e&&(OT.$.removeElement(e),e=null),f&&(f.disconnect(),f=null),q&&(q.disconnect(),q=null))});this.destroy=function(){f&&(f.disconnect(),f=null);q&&(q.disconnect(),q=null);l&&(l.destroy(),l=null);b&&(OT.$.removeElement(b),b=null)};Object.defineProperties(this,{showPoster:{get:function(){return!OT.$.isDisplayNone(m)},
	set:function(a){a?OT.$.show(m):OT.$.hide(m)}},poster:{get:function(){return OT.$.css(m,"backgroundImage")},set:function(a){OT.$.css(m,"backgroundImage","url("+a+")")}},loading:{get:function(){return p},set:function(a){(p=a)?OT.$.addClass(b,"OT_loading"):OT.$.removeClass(b,"OT_loading")}},video:{get:function(){return l},set:function(a){l&&l.destroy();a.appendTo(e);l=a;l.on({orientationChanged:function(){c(e,b.offsetWidth,b.offsetHeight,l.aspectRatio,l.isRotated)}});c(e,b.offsetWidth,b.offsetHeight,
...
(function(k){var c=function(){if(navigator.getUserMedia)return navigator.getUserMedia.bind(navigator);if(navigator.mozGetUserMedia)return navigator.mozGetUserMedia.bind(navigator);if(navigator.webkitGetUserMedia)return navigator.webkitGetUserMedia.bind(navigator)}();navigator.webkitGetUserMedia?(webkitMediaStream.prototype.getVideoTracks||(webkitMediaStream.prototype.getVideoTracks=function(){return this.videoTracks}),webkitMediaStream.prototype.getAudioTracks||(webkitMediaStream.prototype.getAudioTracks=
		...
		!OT.$.isObject(a))return!0;for(var b in a)if(a[b])return!1;return!0};OT.$.supportsWebRTC=function(){var a=!1;if(navigator.webkitGetUserMedia)a="function"===typeof webkitRTCPeerConnection&&!!webkitRTCPeerConnection.prototype.addStream;else if(navigator.mozGetUserMedia){var b=k.navigator.userAgent.toLowerCase().match(/Firefox\/([0-9\.]+)/i);if(a="function"===typeof mozRTCPeerConnection&&null!==b&&20<parseFloat(b[1],10))try{new mozRTCPeerConnection,a=!0}catch(d){a=!1}}OT.$.supportsWebRTC=function(){return a};
	return a};OT.$.supportedCryptoScheme=function(){if(!OT.$.supportsWebRTC())return"NONE";var a=k.navigator.userAgent.toLowerCase().match(/chrome\/([0-9\.]+)/i);return a&&25>parseFloat(a[1],10)?"SDES_SRTP":"DTLS_SRTP"};OT.$.supportsBundle=function(){return OT.$.supportsWebRTC()&&"Chrome"===OT.$.browser()};OT.$.supportsRtcpMux=function(){return OT.$.supportsWebRTC()&&"Chrome"===OT.$.browser()};OT.$.getUserMedia=function(a,f,l,q,m,k){if(b(a))OT.error("Couldn't get UserMedia: All constraints were false"),
		l.call(null,{name:"NO_VALID_CONSTRAINTS",message:"Video and Audio was disabled, you need to enabled at least one"});else{var p=null,t=!1,n=function(){p=null;t=!0;q&&q()},s=function(a){p&&clearTimeout(p);t&&m&&m();f.call(null,a)},u=function(a){p&&clearTimeout(p);t&&m&&m();var b;OT.$.isObject(a)&&a.name?b={name:a.name,message:a.message,constraintName:a.constraintName}:OT.$.isObject(a)?(b=d(a.code,g),a.message&&(b.message=a.message),a.constraintName&&(b.constraintName=a.constraintName)):b=a&&e.hasOwnProperty(a)?
		d(a,e):{message:"Unknown Error while getting user media"};a=b;"PERMISSION_DENIED"===a.name||"PermissionDeniedError"===a.name?k.call(null,a):l.call(null,a)};try{c(a,s,u)}catch(w){OT.error("Couldn't get UserMedia: "+w.toString());u();return}p=-1===location.protocol.indexOf("https")?setTimeout(n,100):setTimeout(n,500)}};OT.$.createPeerConnection=function(a,b){return new (k.webkitRTCPeerConnection||k.mozRTCPeerConnection)(a,b)}})(window);
(function(k){function c(a,d){var c=document.createElement("video");c.setAttribute("autoplay","");c.innerHTML=a;if(d){!0===d.muted&&(delete d.muted,c.muted="true");for(var e in d)c.setAttribute(e,d[e])}return c}function e(a){return d[parseInt(a,10)]||"An unknown error occurred."}function g(a,d,c,g){if(navigator.mozGetUserMedia||0<d.getVideoTracks().length&&d.getVideoTracks()[0].enabled){var q=function(){clearTimeout(p);a.removeEventListener("loadedmetadata",m,!1);a.removeEventListener("error",r,!1)},
		m=function(a){q();c()},r=function(a){q();g("There was an unexpected problem with the Video Stream: "+e(a.target.error.code))},p=setTimeout(function(){0===a.currentTime?g("The video stream failed to connect. Please notify the site owner if this continues to happen."):(OT.warn("Never got the loadedmetadata event but currentTime \x3e 0"),c())}.bind(this),3E4);a.addEventListener("loadedmetadata",m,!1);a.addEventListener("error",r,!1);d.onended=function(){q();g("Stream ended while trying to bind it to a video element.")}}else c();
	void 0!==a.srcObject?a.srcObject=d:void 0!==a.mozSrcObject?a.mozSrcObject=d:a.src=k.URL.createObjectURL(d);a.play()}OT.VideoOrientation={ROTATED_NORMAL:"OTVideoOrientationRotatedNormal",ROTATED_LEFT:"OTVideoOrientationRotatedLeft",ROTATED_RIGHT:"OTVideoOrientationRotatedRight",ROTATED_UPSIDE_DOWN:"OTVideoOrientationRotatedUpsideDown"};OT.VideoElement=function(a){var d,f,l,q=!1,m=!1;a=OT.$.defaults(a||{},{fallbackText:"Sorry, Web RTC is not available in your browser"});OT.$.eventing(this);var r=function(a){a=
		"There was an unexpected problem with the Video Stream: "+e(a.target.error.code);this.trigger("error",null,a,this)}.bind(this),p=function(){q=!0;f.addEventListener("error",r,!1);this.trigger("streamBound",this)}.bind(this),t=function(a){this.trigger("loadError",OT.ExceptionCodes.P2P_CONNECTION_FAILED,a,this)}.bind(this),n=function(){m||(OT.warn("Video element paused, auto-resuming. If you intended to do this, use publishVideo(false) or subscribeToVideo(false) instead."),m=!0);f.play()};f=c(a.fallbackText,
		a.attributes);f.addEventListener("pause",n);Object.defineProperties(this,{stream:{get:function(){return d}},domElement:{get:function(){return f}},parentElement:{get:function(){return l}},isBoundToStream:{get:function(){return q}},poster:{get:function(){return f.getAttribute("poster")},set:function(a){f.setAttribute("poster",a)}}});this.appendTo=function(a){l=a;l.appendChild(f);return this};this.bindToStream=function(a){q=!1;d=a;g(f,d,p,t);return this};this.unbindStream=function(){if(!d)return this;
...
(function(k){var c=[],e=!1;OT.Analytics=function(){var g=OT.properties.loggingURL+"/logging/ClientEvent",a=OT.properties.loggingURL+"/logging/ClientQos",d={},b={payloadType:"payload_type",partnerId:"partner_id",streamId:"stream_id",sessionId:"session_id",connectionId:"connection_id",widgetType:"widget_type",widgetId:"widget_id",avgAudioBitrate:"avg_audio_bitrate",avgVideoBitrate:"avg_video_bitrate",localCandidateType:"local_candidate_type",remoteCandidateType:"remote_candidate_type",transportType:"transport_type"},
		...
		a[e]&&(a[b[e]]=a[e],delete a[e]);c.push({data:a,onComplete:function(){},isQos:!1});f()};this.logQOS=function(a){var d=a.partnerId;a||(a={});a=OT.$.extend({guid:this.getClientGuid(),widget_id:"",session_id:"",connection_id:"",stream_id:"",partner_id:d,source:k.location.href,build:"",duration:0},a);for(var e in b)b.hasOwnProperty(e)&&a[e]&&(a[b[e]]=a[e],delete a[e]);c.push({data:a,onComplete:function(){},isQos:!0});f()};this.escapePayload=function(a){var b=[],d=[],c;for(c in a)a.hasOwnProperty(c)&&
		(null!==a[c]&&void 0!==a[c])&&(b.push(a[c]?a[c].toString().replace("|","\\|"):""),d.push(c.toString().replace("|","\\|")));return[d.join("|"),b.join("|")]};this.getClientGuid=function(){var a=OT.$.getCookie("opentok_client_id");a||(a=OT.$.uuid(),OT.$.setCookie("opentok_client_id",a));return a}}})(window);
...
(function(k){OT.Collection=function(c){var e=[],g={},a=c||"id";OT.$.eventing(this,!0);var d=function(a){this.trigger("update",a);this.trigger("update:"+a.target.id,a)}.bind(this),b=function(a,c){if(void 0!==g[a]){var b=g[a];delete g[a];g[c]=b}}.bind(this),h=function(a){this.remove(a.target,a.reason)}.bind(this);this.reset=function(){e.forEach(function(a){a.off("updated",d,this);a.off("destroyed",h,this);a.off("idUpdated",b,this)},this);e=[];g={}};this.destroy=function(){e.forEach(function(a){a.destroy(void 0,
		!0)});this.reset();this.off()};this.get=function(a){return a&&void 0!==g[a]?e[g[a]]:void 0};this.has=function(a){return a&&void 0!==g[a]};this.toString=function(){return e.toString()};this.where=function(a,c){return OT.$.isFunction(a)?e.filter(a,c):e.filter(function(c){for(var b in a)if(c[b]!==a[b])return!1;return!0})};this.find=function(a,c){var b;b=OT.$.isFunction(a)?a:function(c){for(var b in a)if(c[b]!==a[b])return!1;return!0};b=b.bind(c);for(var d=0;d<e.length;++d)if(!0===b(e[d]))return e[d];
	return null};this.add=function(c){var l=c[a];if(this.has(l))return OT.warn("Model "+l+" is already in the collection",e),this;g[l]=e.push(c)-1;c.on("updated",d,this);c.on("destroyed",h,this);c.on("idUpdated",b,this);this.trigger("add",c);this.trigger("add:"+l,c);return this};this.remove=function(c,l){var k=c[a];e.splice(g[k],1);for(var m=g[k];m<e.length;++m)g[e[m][a]]=m;delete g[k];c.off("updated",d,this);c.off("destroyed",h,this);c.off("idUpdated",b,this);this.trigger("remove",c,l);this.trigger("remove:"+
		k,c,l);return this};OT.$.defineGetters(this,{length:function(){return e.length}})}})(this);
...
(function(k){function c(a,c,b){return c<=a&&a<=b}function e(a,c){return Math.floor(a/c)}function g(a){var c=0;this.get=function(){return c>=a.length?-1:Number(a[c])};this.offset=function(b){c+=b;if(0>c)throw Error("Seeking past start of the buffer");if(c>a.length)throw Error("Seeking past EOF");};this.match=function(b){if(b.length>c+a.length)return!1;var d;for(d=0;d<b.length;d+=1)if(Number(a[c+d])!==b[d])return!1;return!0}}function a(a){var c=0;this.emit=function(b){var d=-1,e;for(e=0;e<arguments.length;++e)d=
	...
	if(-1===e)return-1;b.offset(1);if(c(e,0,127))return e;b=a[e-128];return null===b?f(d):b}}function s(a,b){this.encode=function(b,d){var e=d.get();if(-1===e)return-1;d.offset(1);if(c(e,0,127))return b.emit(e);var f=r(e,a);null===f&&l(e);return b.emit(f+128)}}function u(a,b){var d=b.fatal,e=0,h=0,g=0;this.decode=function(b){var l=b.get();if(-1===l&&0===e&&0===h&&0===g)return-1;if(-1===l&&(0!==e||0!==h||0!==g))g=h=e=0,f(d);b.offset(1);var v;if(0!==g){v=null;if(c(l,48,57))if(l=10*(126*(10*(e-129)+(h-48))+
		(g-129))+l-48,39419<l&&189E3>l||1237575<l)v=null;else{var k=0;v=0;var F=A.gb18030,q;for(q=0;q<F.length;++q){var H=F[q];if(H[0]<=l)k=H[0],v=H[1];else break}v=v+l-k}g=h=e=0;return null===v?(b.offset(-3),f(d)):v}if(0!==h){if(c(l,129,254))return g=l,null;b.offset(-2);h=e=0;return f(d)}if(0!==e){if(c(l,48,57)&&a)return h=l,null;v=e;k=null;e=0;F=127>l?64:65;if(c(l,64,126)||c(l,128,254))k=190*(v-129)+(l-F);v=null===k?null:m(k,A.gbk);null===k&&b.offset(-1);return null===v?f(d):v}return c(l,0,127)?l:128===
		l?8364:c(l,129,254)?(e=l,null):f(d)}}function w(a,b){this.encode=function(b,d){var f=d.get();if(-1===f)return-1;d.offset(1);if(c(f,0,127))return b.emit(f);var h=r(f,A.gbk);if(null!==h)return f=e(h,190)+129,h%=190,b.emit(f,h+(63>h?64:65));if(null===h&&!a)return l(f);var g=h=0,m=A.gb18030,v;for(v=0;v<m.length;++v){var k=m[v];if(k[1]<=f)h=k[1],g=k[0];else break}h=g+f-h;f=e(e(e(h,10),126),10);h-=12600*f;g=e(e(h,10),126);h-=1260*g;m=e(h,10);return b.emit(f+129,g+48,m+129,h-10*m+48)}}function x(a){var b=
	...
	if(null===f)return l(d);d=e(f,157)+129;f%=157;return a.emit(d,f+(63>f?64:98))}}function G(a){var b=a.fatal,d=0,e=0;this.decode=function(a){var h=a.get();if(-1===h){if(0===d&&0===e)return-1;e=d=0;return f(b)}a.offset(1);var g,l;return 0!==e?(g=e,e=0,l=null,c(g,161,254)&&c(h,161,254)&&(l=m(94*(g-161)+h-161,A.jis0212)),c(h,161,254)||a.offset(-1),null===l?f(b):l):142===d&&c(h,161,223)?(d=0,65377+h-161):143===d&&c(h,161,254)?(d=0,e=h,null):0!==d?(g=d,d=0,l=null,c(g,161,254)&&c(h,161,254)&&(l=m(94*(g-161)+
		h-161,A.jis0208)),c(h,161,254)||a.offset(-1),null===l?f(b):l):c(h,0,127)?h:142===h||143===h||c(h,161,254)?(d=h,null):f(b)}}function E(a){this.encode=function(a,b){var d=b.get();if(-1===d)return-1;b.offset(1);if(c(d,0,127))return a.emit(d);if(165===d)return a.emit(92);if(8254===d)return a.emit(126);if(c(d,65377,65439))return a.emit(142,d-65377+161);var f=r(d,A.jis0208);if(null===f)return l(d);d=e(f,94)+161;return a.emit(d,f%94+161)}}function C(a){var d=a.fatal,b=0,e=!1,h=0;this.decode=function(a){var g=
		a.get();-1!==g&&a.offset(1);switch(b){default:case 0:return 27===g?(b=1,null):c(g,0,127)?g:-1===g?-1:f(d);case 1:if(36===g||40===g)return h=g,b=2,null;-1!==g&&a.offset(-1);b=0;return f(d);case 2:var l=h;h=0;if(36===l&&(64===g||66===g))return e=!1,b=4,null;if(36===l&&40===g)return b=3,null;if(40===l&&(66===g||74===g))return b=0,null;if(40===l&&73===g)return b=6,null;-1===g?a.offset(-1):a.offset(-2);b=0;return f(d);case 3:if(68===g)return e=!0,b=4,null;-1===g?a.offset(-2):a.offset(-3);b=0;return f(d);
	case 4:if(10===g)return b=0,f(d,10);if(27===g)return b=1,null;if(-1===g)return-1;h=g;b=5;return null;case 5:b=4;if(-1===g)return f(d);a=null;l=94*(h-33)+g-33;c(h,33,126)&&c(g,33,126)&&(a=!1===e?m(l,A.jis0208):m(l,A.jis0212));return null===a?f(d):a;case 6:return 27===g?(b=1,null):c(g,33,95)?65377+g-33:-1===g?-1:f(d)}}}function v(a){var b=0;this.encode=function(a,d){var f=d.get();if(-1===f)return-1;d.offset(1);if((c(f,0,127)||165===f||8254===f)&&0!==b)return d.offset(-1),b=0,a.emit(27,40,66);if(c(f,
		...
		(31>d?129:193),f+(63>f?64:65))}}function I(a){var d=a.fatal,b=0;this.decode=function(a){var e=a.get();if(-1===e&&0===b)return-1;if(-1===e&&0!==b)return b=0,f(d);a.offset(1);if(0!==b){var h=b,g=null;b=0;if(c(h,129,198)){var l=178*(h-129);c(e,65,90)?g=l+e-65:c(e,97,122)?g=l+26+e-97:c(e,129,254)&&(g=l+26+26+e-129)}c(h,199,253)&&c(e,161,254)&&(g=12460+94*(h-199)+(e-161));e=null===g?null:m(g,A["euc-kr"]);null===g&&a.offset(-1);return null===e?f(d):e}return c(e,0,127)?e:c(e,129,253)?(b=e,null):f(d)}}function M(a){this.encode=
		function(a,d){var b=d.get();if(-1===b)return-1;d.offset(1);if(c(b,0,127))return a.emit(b);var f=r(b,A["euc-kr"]);if(null===f)return l(b);if(12460>f)return b=e(f,178)+129,f%=178,a.emit(b,f+(26>f?65:52>f?71:77));f-=12460;b=e(f,94)+199;return a.emit(b,f%94+161)}}function N(a){var b=a.fatal,d=0,e=0;this.decode=function(a){var h=a.get();-1!==h&&a.offset(1);switch(d){default:case 0:return 14===h?(d=4,null):15===h?null:27===h?(d=1,null):c(h,0,127)?h:-1===h?-1:f(b);case 1:if(36===h)return d=2,null;-1!==h&&
a.offset(-1);d=0;return f(b);case 2:if(41===h)return d=3,null;-1===h?a.offset(-1):a.offset(-2);d=0;return f(b);case 3:if(67===h)return d=0,null;-1===h?a.offset(-2):a.offset(-3);d=0;return f(b);case 4:if(10===h)return d=0,f(b,10);if(14===h)return null;if(15===h)return d=0,null;if(-1===h)return-1;e=h;d=5;return null;case 5:d=4;if(-1===h)return f(b);a=null;c(e,33,70)&&c(h,33,126)?a=m(178*(e-1)+52+h-1,A["euc-kr"]):c(e,71,126)&&c(h,33,126)&&(a=m(12460+94*(e-71)+(h-33),A["euc-kr"]));return null!==a?a:f(b)}}}
	function O(a){var b=!1,d=0;this.encode=function(a,f){var h=f.get();if(-1===h)return-1;b||(b=!0,a.emit(27,36,41,67));f.offset(1);if(c(h,0,127)&&0!==d)return f.offset(-1),d=0,a.emit(15);if(c(h,0,127))return a.emit(h);if(1!==d)return f.offset(-1),d=1,a.emit(14);var g=r(h,A["euc-kr"]);if(null===g)return l(h);var m;if(12460>g)return m=e(g,178)+1,g=g%178-26-26+1,!c(m,33,70)||!c(g,33,126)?l(h):a.emit(m,g);g-=12460;m=e(g,94)+71;g=g%94+33;return!c(m,71,126)||!c(g,33,126)?l(h):a.emit(m,g)}}function K(a,d){var b=
		...
		{encodings:[{labels:["big5","big5-hkscs","cn-big5","csbig5","x-x-big5"],name:"big5"}],heading:"Legacy multi-byte Chinese (traditional) encodings"},{encodings:[{labels:["cseucpkdfmtjapanese","euc-jp","x-euc-jp"],name:"euc-jp"},{labels:["csiso2022jp","iso-2022-jp"],name:"iso-2022-jp"},{labels:"csshiftjis ms_kanji shift-jis shift_jis sjis windows-31j x-sjis".split(" "),name:"shift_jis"}],heading:"Legacy multi-byte Japanese encodings"},{encodings:[{labels:"cseuckr csksc56011987 euc-kr iso-ir-149 korean ks_c_5601-1987 ks_c_5601-1989 ksc5601 ksc_5601 windows-949".split(" "),
			name:"euc-kr"},{labels:["csiso2022kr","iso-2022-kr"],name:"iso-2022-kr"}],heading:"Legacy multi-byte Korean encodings"},{encodings:[{labels:["utf-16","utf-16le"],name:"utf-16"},{labels:["utf-16be"],name:"utf-16be"}],heading:"Legacy utf-16 encodings"}].forEach(function(a){a.encodings.forEach(function(a){z[a.name]=a;a.labels.forEach(function(b){L[b]=a})})});var A=k["encoding-indexes"]||{};z["utf-8"].getEncoder=function(a){return new t(a)};z["utf-8"].getDecoder=function(a){return new p(a)};(function(){"ibm864 ibm866 iso-8859-2 iso-8859-3 iso-8859-4 iso-8859-5 iso-8859-6 iso-8859-7 iso-8859-8 iso-8859-10 iso-8859-13 iso-8859-14 iso-8859-15 iso-8859-16 koi8-r koi8-u macintosh windows-874 windows-1250 windows-1251 windows-1252 windows-1253 windows-1254 windows-1255 windows-1256 windows-1257 windows-1258 x-mac-cyrillic".split(" ").forEach(function(a){var b=
			z[a],d=A[a];b.getDecoder=function(a){return new n(d,a)};b.getEncoder=function(a){return new s(d,a)}})})();z.gbk.getEncoder=function(a){return new w(!1,a)};z.gbk.getDecoder=function(a){return new u(!1,a)};z.gb18030.getEncoder=function(a){return new w(!0,a)};z.gb18030.getDecoder=function(a){return new u(!0,a)};z["hz-gb-2312"].getEncoder=function(a){return new y(a)};z["hz-gb-2312"].getDecoder=function(a){return new x(a)};z.big5.getEncoder=function(a){return new D(a)};z.big5.getDecoder=function(a){return new B(a)};
...
else{b=c;m=f;try{s("connecting"),d=new (a||WebSocket)(e),d.binaryType="arraybuffer",d.onopen=B,d.onclose=E,d.onerror=G,d.onmessage=C,p=setTimeout(D,OT.Rumor.Socket.CONNECT_TIMEOUT)}catch(h){OT.error(h),w("Could not connect to the Rumor socket, possibly because of a blocked port.")}}};this.disconnect=function(){p&&clearTimeout(p);n&&clearTimeout(n);d?3===d.readyState?this.isNot("error")&&s("disconnected"):(this.is("connected")&&d.send(OT.Rumor.Message.Disconnect().serialize()),x()):this.isNot("error")&&
		s("disconnected")};Object.defineProperties(this,{id:{get:function(){return b}},onOpen:{set:function(a){u("onOpen",a);h=a},get:function(){return h}},onError:{set:function(a){u("onError",a);f=a},get:function(){return f}},onClose:{set:function(a){u("onClose",a);l=a},get:function(){return l}},onMessage:{set:function(a){u("onMessage",a);k=a},get:function(){return k}}})};OT.Rumor.Socket.CONNECT_TIMEOUT=15E3})(this);
(function(k){OT.Rumor.Message=function(c,e,g,a){this.type=c;this.toAddress=e;this.headers=g;this.data=a};OT.Rumor.Message.prototype.serialize=function(){var c=8,e=7,g=Array(this.toAddress.length),a=Array(this.headers.length),d=Array(this.headers.length),b;e++;for(var h=0;h<this.toAddress.length;h++)g[h]=(new TextEncoder("utf-8")).encode(this.toAddress[h]),e+=2,e+=g[h].length;e++;for(h=0;h<this.headers.length;h++)a[h]=(new TextEncoder("utf-8")).encode(this.headers[h].key),d[h]=(new TextEncoder("utf-8")).encode(this.headers[h].val),
		e+=4,e+=a[h].length,e+=d[h].length;b=(new TextEncoder("utf-8")).encode(this.data);var e=e+b.length,f=new ArrayBuffer(e),l=new Uint8Array(f,0,e),e=e-4;l[0]=(e&4278190080)>>>24;l[1]=(e&16711680)>>>16;l[2]=(e&65280)>>>8;l[3]=(e&255)>>>0;l[4]=0;l[5]=0;l[6]=this.type;l[7]=this.toAddress.length;for(h=0;h<g.length;h++){strArray=g[h];l[c++]=strArray.length>>8&255;l[c++]=strArray.length>>0&255;for(e=0;e<strArray.length;e++)l[c++]=strArray[e]}l[c++]=a.length;for(h=0;h<a.length;h++){strArray=a[h];l[c++]=strArray.length>>
		8&255;l[c++]=strArray.length>>0&255;for(e=0;e<strArray.length;e++)l[c++]=strArray[e];strArray=d[h];l[c++]=strArray.length>>8&255;l[c++]=strArray.length>>0&255;for(e=0;e<strArray.length;e++)l[c++]=strArray[e]}for(h=0;h<b.length;h++)l[c++]=b[h];return f};OT.Rumor.Message.deserialize=function(c){var e,g=8,a=new Uint8Array(c);e=a[6];for(var d=[],b=0;b<a[7];b++){length=a[g++]<<8;length+=a[g++];var h=new Uint8Array(c,g,length);d[b]=(new TextDecoder("utf-8")).decode(h);g+=length}for(var f=a[g++],l=[],b=
		0;b<f;b++){length=a[g++]<<8;length+=a[g++];var h=new Uint8Array(c,g,length),k=(new TextDecoder("utf-8")).decode(h),g=g+length;length=a[g++]<<8;length+=a[g++];h=new Uint8Array(c,g,length);h=(new TextDecoder("utf-8")).decode(h);l[b]={key:k,val:h};g+=length}c=new Uint8Array(c,g);c=(new TextDecoder("utf-8")).decode(c);return new OT.Rumor.Message(e,d,l,c)};OT.Rumor.Message.Connect=function(c,e){return new OT.Rumor.Message(OT.Rumor.MessageType.CONNECT,[],[{key:"uniqueId",val:c},{key:"notifyDisconnectAddress",
	val:e}],"")};OT.Rumor.Message.Disconnect=function(){return new OT.Rumor.Message(OT.Rumor.MessageType.DISCONNECT,[],[],"")};OT.Rumor.Message.Subscribe=function(c){return new OT.Rumor.Message(OT.Rumor.MessageType.SUBSCRIBE,c,[],"")};OT.Rumor.Message.Unsubscribe=function(c){return new OT.Rumor.Message(OT.Rumor.MessageType.UNSUBSCRIBE,c,[],"")};OT.Rumor.Message.Publish=function(c,e,g){return new OT.Rumor.Message(OT.Rumor.MessageType.MESSAGE,c,[],e)};OT.Rumor.Message.Ping=function(){return new OT.Rumor.Message(OT.Rumor.MessageType.PING,
		[],[],"")}})(this);
...
(function(k){var c="hasAudio hasVideo quality name videoDimensions orientation".split(" ");OT.Stream=function(e,g,a,d,b,h,f,l,k,m,r,p,t){var n;this.id=this.streamId=e;this.connection=g;this.name=a;this.data=d;this.type=b||"basic";this.creationTime=h?Number(h):null;this.hasAudio=OT.$.castToBoolean(f,!0);this.hasVideo=OT.$.castToBoolean(l,!0);this.peerId=m;this.quality=r;this.videoDimensions={width:p||640,height:t||480,orientation:k||OT.VideoOrientation.ROTATED_NORMAL};OT.$.eventing(this);this.update=
		function(a,b){if(-1===c.indexOf(a))OT.warn('Unknown stream property "'+a+'" was modified to "'+b+'".');else{var d=this[a],e=b;switch(a){case "hasAudio":case "hasVideo":e=OT.$.castToBoolean(e,!0);this[a]=e;break;case "quality":case "name":this[a]=e;break;case "orientation":this.videoDimensions={width:e.width,height:e.height,orientation:e.videoOrientation}}d=new OT.StreamUpdatedEvent(this,a,d,e);this.dispatchEvent(d)}};this.destroy=function(a,b){n=a||"clientDisconnected";!0!==b&&this.dispatchEvent(new OT.DestroyedEvent("destroyed",
...
(function(k){var c=k.mozRTCSessionDescription||k.RTCSessionDescription,e=k.mozRTCIceCandidate||k.RTCIceCandidate,g=function(a){return function(b){OT.debug("IceCandidateForwarder: Ice Candidate");b.candidate?a(OT.Raptor.Actions.CANDIDATE,b.candidate):OT.debug("IceCandidateForwarder: No more ICE candidates.")}},a=function(){var a=[],b=null;Object.defineProperty(this,"peerConnection",{set:function(a){b=a}});this.process=function(d){d=new e(d.candidate);b?b.addIceCandidate(d):a.push(d)};this.processPending=
		...
		h=function(a,b,c){var e={mandatory:{},optional:[]},g=function(a){return function(b){c&&c(a,b)}};navigator.mozGetUserMedia&&(e.mandatory.MozDontOfferDataChannel=!0);a.createOffer(function(c){c.sdp=d(c.sdp);a.setLocalDescription(c,function(){b(c)},g("SetLocalDescription:Error while setting LocalDescription"))},g("CreateOffer:Error while creating Offer"),e)};OT.PeerConnection=function(d){var e,q=new a,m,r,p="new",t=[],n,s=OT.$.now();OT.$.eventing(this);d.iceServers||(d.iceServers=[]);var u=function(a,
																																																																																																																																																																																																																																																												 b){if(t.length)t[0](a,b)}.bind(this),w=function(){if(!e){try{OT.debug('Creating peer connection config "'+JSON.stringify(d)+'".'),e=OT.$.createPeerConnection(d,{optional:[{DtlsSrtpKeyAgreement:!0}]})}catch(a){return v("NewPeerConnection: "+a.message),null}q.peerConnection=e;e.onicecandidate=g(u);e.onaddstream=B.bind(this);e.onremovestream=D.bind(this);void 0!==e.onsignalingstatechange?e.onsignalingstatechange=y.bind(this):void 0!==e.onstatechange&&(e.onstatechange=y.bind(this))}return e}.bind(this),
		x=function(){q&&(q.peerConnection=null);null!==e&&(e=null,this.trigger("close"))},y=function(a){a="string"===typeof a?a:a.target&&a.target.signalingState?a.target.signalingState:a.target.readyState;OT.debug("PeerConnection.stateChange: "+a);if(a&&a.toLowerCase()!==p)switch(p=a.toLowerCase(),OT.debug("PeerConnection.stateChange: "+p),p){case "closed":x.call(this);break;case "failed":v("ICEWorkflow: Ice state failed")}},B=function(a){this.trigger("streamAdded",a.stream)},D=function(a){this.trigger("streamRemoved",
				a.stream)},G=function(a){a=new c(a.sdp);w();_remoteDescriptionType=a.type;_remoteDescription=a;b(e,a,function(a){u(OT.Raptor.Actions.ANSWER,a)},function(a,b){v(a+":"+b+":PeerConnection.offerProcessor")})},E=function(a){a.sdp?(r=new c(a.sdp),_remoteDescriptionType=r.type,_remoteDescription=r,e.setRemoteDescription(r,function(){OT.debug("setRemoteDescription succeeded")},function(a){v("SetRemoteDescription:Error while setting RemoteDescription: "+a)}),q.processPending()):OT.error("PeerConnection.processMessage: Weird message, no SDP.")},
		C=function(a){OT.debug("PeerConnection.processSubscribe: Sending offer to subscriber.");w();h(e,function(a){m=a;u(OT.Raptor.Actions.OFFER,m)},function(a,b){v(a+":"+b+": PeerConnection.suscribeProcessor")})},v=function(a){OT.error(a);this.trigger("error",a)}.bind(this);this.addLocalStream=function(a){w();e.addStream(a)};this.disconnect=function(){q=null;if(e){var a=e.signalingState||e.readyState;a&&"closed"!==a.toLowerCase()&&e.close();x.call(this)}this.off()};this.processMessage=function(a,b){OT.debug("PeerConnection.processMessage: Received "+
		...
		c.stat("googRemoteCandidateType"),h.transportType=c.stat("googTransportType"));var e=f(c);isNaN(e)||(h.avgVideoBitrate=e);c=g(c);isNaN(c)||(h.avgAudioBitrate=c)}}}n=!1;b(h)};h.duration=Math.round(d-s);var d=function(a){for(var d in a)if(a.hasOwnProperty(d)&&("outboundrtp"===a[d].type||"inboundrtp"===a[d].type)){var c=a[d];-1!==c.id.indexOf("video")?(c=f(c),isNaN(c)||(h.avgVideoBitrate=c)):-1!==c.id.indexOf("audio")&&(c=g(c),isNaN(c)||(h.avgAudioBitrate=c))}n=!1;b(h)},v=function(){var a=k.navigator.userAgent.toLowerCase().match(/Firefox\/([0-9\.]+)/i),
		b=null!==a&&27<=parseFloat(a[1],10);v=function(){return b};return b};e&&e.getStats?v()?e.getStats(null,d,function(a){OT.warn("Error collecting stats",a);n=!1}):e.getStats(m):(n=!1,b(h))}};Object.defineProperty(this,"remoteStreams",{get:function(){var a;if(e){if(e.getRemoteStreams)a=e.getRemoteStreams();else if(e.remoteStreams)a=e.remoteStreams;else throw Error("Invalid Peer Connection object implements no method for retrieving remote streams");a=Array.prototype.slice.call(a)}else a=[];return a}})}})(window);
...
(function(k){var c={audio:!0,video:!0};OT.Publisher=function(){if(OT.checkSystemRequirements()){var e=OT.Publisher.nextId(),g,a,d,b,h,f,l={},k=!1,m,r,p,t,n,s=new OT.Analytics,u={},w={timeStamp:OT.$.now()},x;OT.$.eventing(this);OT.StylableComponent(this,{showMicButton:!0,showSettingsButton:!0,showCameraToggleButton:!0,nameDisplayMode:"auto",buttonDisplayMode:"auto",backgroundImageURI:null});var y=function(a,d,c,g){s.logEvent({action:a,variation:d,payload_type:c,payload:g,session_id:f?f.sessionId:null,
	connection_id:f&&f.connected?f.connection.connectionId:null,partner_id:f?f.apiKey:OT.APIKEY,streamId:b?b.id:null,widget_id:e,widget_type:"Publisher"})},B=function(a){var d={widget_type:"Publisher",stream_type:"WebRTC",sessionId:f?f.sessionId:null,connectionId:f&&f.connected?f.connection.connectionId:null,partnerId:f?f.apiKey:OT.APIKEY,streamId:b?b.id:null,widgetId:e,version:OT.properties.version,media_server_name:f?f.sessionInfo.messagingServer:null,p2pFlag:f?f.sessionInfo.p2pEnabled:!1,duration:(new Date).getTime()-
		r.getTime(),remote_connection_id:a};l[a].getStats(w,function(a){if(a)for(var b in a)d[b]=a[b];s.logQOS(d)})},D=function(){OT.debug("OT.Publisher.onLoaded");x.set("MediaBound");a.loading=!1;k=!0;n=(new OT.Chrome({parent:a.domElement})).set({name:new OT.Chrome.NamePanel({name:m.name,mode:this.getStyle("nameDisplayMode")}),muteButton:new OT.Chrome.MuteButton({muted:!1===m.publishAudio,mode:K.call(this,this.getStyle("showMicButton"))}),opentokButton:new OT.Chrome.OpenTokButton}).on({muted:this.publishAudio.bind(this,
	...
	if(!d){var c=OT.$.now();y("createPeerConnection","Attempt","","");a.on("destroyed",this.cleanupSubscriber.bind(this,a.id));d=l[a.id]=new OT.PublisherPeerConnection(a,f,b,h);d.on({connected:function(){y("createPeerConnection","Success","pcc|hasRelayCandidates",[parseInt(OT.$.now()-c,10),d.hasRelayCandidates].join("|"));u[a.id]=setInterval(function(){B(a.id)},3E4)},disconnected:M,error:N},this);d.init()}return d},K=function(a){if(!1===a)return"off";a=this.getStyle("buttonDisplayMode");return!1===a?
		"on":a},J=function(){n&&(n.destroy(),n=null);this.disconnect();t=null;d&&(d.destroy(),d=null);h&&(h.stop(),h=null);a&&(a.destroy(),a=null);this.session&&this._.unpublishFromSession(this.session);for(var c in u)clearInterval(u[c]),delete u[c];b=g=null;k=!1;_properties=f=null;x.set("NotPublishing")}.bind(this);this.publish=function(b,d){OT.debug("OT.Publisher: publish");(x.attemptingToPublish||x.publishing)&&J();x.set("GetUserMedia");m=OT.$.defaults(d||{},{publishAudio:!0,publishVideo:!0,mirror:!0});
...
(function(k){OT.Subscriber=function(c,e){var g=OT.$.uuid(),a=c||g,d,b,h,f,l,k,m=e.session,r,p,t,n=OT.$.clone(e),s=new OT.Analytics,u=50,w,x,y={timeStamp:OT.$.now()};if(m){OT.$.eventing(this);OT.StylableComponent(this,{nameDisplayMode:"auto",buttonDisplayMode:"auto",backgroundImageURI:null});var B=function(a,b,d,c){s.logEvent({action:a,variation:b,payload_type:d,payload:c,stream_id:f?f.id:null,session_id:m?m.sessionId:null,connection_id:m&&m.connected?m.connection.connectionId:null,partner_id:m&&m.connected?
		...
		E=function(){OT.debug("OT.Subscriber has been disconnected from the Publisher's PeerConnection");w.attemptingToSubscribe?(w.set("Failed"),this.trigger("subscribeError","ClientDisconnected")):w.subscribing&&w.set("Failed");this.disconnect()},C=function(a,b){w.attemptingToSubscribe?(B("createPeerConnection","Failure","reason|hasRelayCandidates",["Subscriber PeerConnection Error: "+b,k&&k.hasRelayCandidates].join("|")),w.set("Failed"),this.trigger("subscribeError",b)):w.subscribing&&(w.set("Failed"),
			...
			videoOrientation:f.videoDimensions.orientation};break;case "hasVideo":d&&(d.showPoster=!(f.hasVideo&&n.subscribeToVideo))}},I=function(){h=(new OT.Chrome({parent:d.domElement})).set({name:new OT.Chrome.NamePanel({name:n.name,mode:this.getStyle("nameDisplayMode")}),opentokButton:new OT.Chrome.OpenTokButton}).on({muted:function(){},unmuted:function(){}})};this.recordQOS=function(){D()};this.subscribe=function(b){OT.debug("OT.Subscriber: subscribe to "+b.id);if(w.subscribing)return OT.error("OT.Subscriber.Subscribe: Cannot subscribe, already subscribing."),
		!1;w.set("Init");if(!b)return OT.error("OT.Subscriber: No stream parameter."),!1;if(f)return OT.error("OT.Subscriber: Already subscribed"),!1;f=b;f.on({updated:H,destroyed:this.disconnect},this);l=b.connection.connectionId;n.name=f.name;n.classNames="OT_root OT_subscriber";n.style&&this.setStyle(n.style,null,!0);n.audioVolume&&this.setAudioVolume(n.audioVolume);n.subscribeToAudio=OT.$.castToBoolean(n.subscribeToAudio,!0);n.subscribeToVideo=OT.$.castToBoolean(n.subscribeToVideo,!0);d=new OT.WidgetView(c,
		n);a=d.domId;!n.subscribeToVideo&&"Chrome"==OT.$.browser()&&(x=!0,n.subscribeToVideo=!0);p=OT.$.now();f.connection.id!==m.connection.id?(B("createPeerConnection","Attempt","",""),w.set("ConnectingToPeer"),k=new OT.SubscriberPeerConnection(f.connection,m,f,n),k.on({disconnected:E,error:C,remoteStreamAdded:v,remoteStreamRemoved:F},this),k.init()):(B("createPeerConnection","Attempt","",""),v.call(this,m.getPublisherForStream(f)._.webRtcStream));B("subscribe","Attempt","streamId",f.id);return this};this.destroy=
		function(b,c){clearInterval(t);t=null;this.disconnect();h&&(h.destroy(),h=null);d&&(d.destroy(),d=null);f&&!f.destroyed&&B("unsubscribe",null,"streamId",f.id);n=m=f=a=null;!0!==c&&this.dispatchEvent(new OT.DestroyedEvent(OT.Event.names.SUBSCRIBER_DESTROYED,this,b),this.off.bind(this));return this};this.disconnect=function(){w.set("NotSubscribing");b&&(b.destroy(),b=null);k&&(k.destroy(),k=null,B("disconnect","PeerConnection","streamId",f.id))};this.processMessage=function(a,b,d){OT.debug("OT.Subscriber.processMessage: Received "+
		...
		this;u=Math.max(0,Math.min(100,a));u!=a&&OT.warn("OT.Subscriber.setAudioVolume: value should be an integer between 0 and 100");b&&b.setAudioVolume(u);return this};this.getAudioVolume=function(){return b?b.getAudioVolume():u};this.subscribeToAudio=function(a){a=OT.$.castToBoolean(a,!0);k&&(k.subscribeToAudio(a),m&&(f&&a!==n.subscribeToAudio)&&m._.modifySubscriber(this,"hasAudio",a));n.subscribeToAudio=a;return this};this.subscribeToVideo=function(a){if(x&&!0==a)x=!1;else return a=OT.$.castToBoolean(a,
		!0),d&&(d.showPoster=!(a&&f.hasVideo),a&&d.video&&(d.loading=a,d.video.whenTimeIncrements(function(){d.loading=!1},this))),k&&(k.subscribeToVideo(a),m&&(f&&a!==n.subscribeToVideo)&&m._.modifySubscriber(this,"hasVideo",a)),n.subscribeToVideo=a,this};Object.defineProperties(this,{id:{get:function(){return a},enumerable:!0},widgetId:{get:function(){return g}},stream:{get:function(){return f},enumerable:!0},streamId:{get:function(){return!f?null:f.id},enumerable:!0},targetElement:{get:function(){return b?
...
(function(k){OT.SessionInfo=function(c){var g=null;this.sessionStatus=this.partnerId=this.sessionId=null;this.p2pEnabled=!1;this.iceServers=this.messagingServer=null;OT.log("SessionInfo Response:");OT.log(c);c&&(c.documentElement&&null!==c.documentElement.firstElementChild)&&(g=c.documentElement.firstElementChild);c=g.firstElementChild;do switch(c.localName){case "session_id":this.sessionId=c.textContent;break;case "partner_id":this.partnerId=c.textContent;break;case "session_status":this.sessionStatus=
		...
		a,parseErrorFromXMLDocument(b.target.responseXML))}})};var c={};c["404"]=OT.ExceptionCodes.INVALID_SESSION_ID;c["403"]=OT.ExceptionCodes.AUTHENTICATION_ERROR;parseErrorFromXMLDocument=function(c){if(c&&c.documentElement&&null!==c.documentElement.firstElementChild){var g=c.evaluate("//error",c.documentElement,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null),a=g.snapshotLength;if(0===a)return!1;for(;0<a;)return c=g.snapshotItem(0),{code:c.getAttribute("code"),message:c.firstElementChild.getAttribute("message")}}return{code:null,
	message:"Unknown error: getSessionInfo XML response was badly formed "+(c&&c.documentElement&&c.documentElement.innerHTML)}};onGetResponseCallback=function(c,g,a){c.logEvent("getSessionInfo","Success","api_url",OT.properties.apiURL);g(new OT.SessionInfo(a))};onGetErrorCallback=function(e,g,a){TB.handleJsException("TB.SessionInfoError :: Unable to get session info "+a.message,c[a.code],{session:e});e.logEvent("Connect","Failure","errorMessage","GetSessionInfo:"+a.code+": Unable to get session info "+
		a.message);g(a,e)};parseIceServersXml=function(c){for(var g=[],a,d,b=0,h=c.length;b<h;++b)"ice_server"===c[b].localName&&(d=c[b].attributes,a={url:d.getNamedItem("url").nodeValue},d.getNamedItem("credential")&&d.getNamedItem("credential").nodeValue.length&&(a.credential=d.getNamedItem("credential").nodeValue),g.push(a));return g};normaliseIceServers=function(c){var g=navigator.userAgent.match(/(Firefox)\/([0-9]+\.[0-9]+)/),a=g?parseFloat(g[2],10):void 0,d;return c.map(function(b){if("turn:"!==b.url.trim().substr(0,
		5))return b;if(null!==g){if(25>a)return{url:b.url.replace("turn:","stun:")};27>a&&-1!==b.url.indexOf("?")&&(b.url=b.url.trim().split("?")[0])}d=b.url.trim().split(/[:@]/);return{username:d[1],credential:b.credential,url:d[0]+":"+d[2]+(4===d.length?":"+d[3]:"")}})}})(window);
(function(k){OT.Capabilities=function(c){this.publish=-1!==c.indexOf("publish")?1:0;this.subscribe=-1!==c.indexOf("subscribe")?1:0;this.forceUnpublish=-1!==c.indexOf("forceunpublish")?1:0;this.forceDisconnect=-1!==c.indexOf("forcedisconnect")?1:0;this.supportsWebRTC=OT.$.supportsWebRTC()?1:0}})(window);
(function(k){var c=function(c,g,a,d){var b,h={},f=function(){clearTimeout(b);c.off("exception",k)},k=function(a){h.hasOwnProperty(a.code)&&this.failed(h[a.code])};this.failsOnExceptionCodes=function(a){h=a};this.succeeded=function(){f();completionHandler&&OT.$.callAsync(completionHandler,null)};this.failed=function(a){f();completionHandler&&OT.$.callAsync(completionHandler,new OT.Error(null,a))};c.on("exception",k,this);b=setTimeout(function(){this.failed(d&&d.timeoutMessage?d.timeoutMessage:"Timed out while waiting for the server to respond.")}.bind(this),
		3E4)};OT.Session=function(e){if(OT.checkSystemRequirements()){var g=!0,a,d,b,h=OT.$.uuid(),f=new OT.Analytics,l,q={},m={};OT.$.eventing(this);var r=OT.$.statable(this,["disconnected","connecting","connected","disconnecting"],"disconnected");this.connections=new OT.Collection;this.streams=new OT.Collection;var p=function(a,b){r("disconnected");OT.error(a);this.trigger("sessionConnectFailed",a);TB.handleJsException(a,b||OT.ExceptionCodes.CONNECT_FAILED,{session:this})},t=function(a){var b=a.reason;
	"networkTimedout"==b?(b="networkDisconnected",this.logEvent("Connect","TimeOutDisconnect","reason",a.reason)):this.logEvent("Connect","Disconnected","reason",a.reason);var c=new OT.SessionDisconnectEvent("sessionDisconnected",b);y.call(this);B.call(this);a=function(){c.isDefaultPrevented()||D.call(this,c.reason)}.bind(this);this.dispatchEvent(c,a)},n=function(a){a.id.match(/^symphony\./)||this.dispatchEvent(new OT.ConnectionEvent(OT.Event.names.CONNECTION_CREATED,[a]))},s=function(a,c){if(!a.id.match(/^symphony\./)&&
		a.id!==b.id){if(q[a.id]){var d=q[a.id];delete q[a.id];"forceDisconnected"!==c&&OT.warn("Expected a forceDisconnect for connection "+a.id+", but a "+c+" was received instead.");d.succeeded()}this.dispatchEvent(new OT.ConnectionEvent(OT.Event.names.CONNECTION_DESTROYED,[a],c))}},u=function(a){this.dispatchEvent(new OT.StreamEvent(OT.Event.names.STREAM_CREATED,[a]))},w=function(a){var b=a.target,c=a.changedProperty,d=a.newValue;"orientation"===c&&(c="videoDimensions",d={width:d.width,height:d.height});
	...
	b=new OT.Raptor.Socket(h,this.sessionInfo.messagingServer);b.connect(d,this.sessionInfo,function(a,b){a?p.call(this,a.reason,a.code):(OT.debug("OT.Session: Received session state from Raptor",b),l=this.connection.id,r("connected"),this.connection.on("destroyed",t,this),this.connections.on({add:n,remove:s},this),this.streams.on({add:u,remove:x,update:w},this),this.dispatchEvent(new OT.SessionConnectEvent(OT.Event.names.SESSION_CONNECTED,b.connections,b.streams,b.archives)))}.bind(this))},E=function(){this.is("connecting")&&
OT.SessionInfo.get(this,C.bind(this),function(a){p.call(this,a.message+(a.code?" ("+a.code+")":""))}.bind(this))},C=function(b){this.is("connecting")&&(this.sessionInfo=b,this.sessionInfo.partnerId&&this.sessionInfo.partnerId!=a?(a=this.sessionInfo.partnerId,this.logEvent("Connect","Failure","reason","GetSessionInfo:"+OT.ExceptionCodes.AUTHENTICATION_ERROR+":Authentication Error: The apiKey passed into the session.connect method does not match the apiKey in the token or session you are trying to connect to."),
		p.call(this,"Authentication Error: The apiKey passed into the session.connect method does not match the apiKey in the token or session you are trying to connect to.",OT.ExceptionCodes.AUTHENTICATION_ERROR)):G.call(this))};this.logEvent=function(b,c,d,g){b={action:b,variation:c,payload_type:d,payload:g,session_id:e,partner_id:a,widget_id:h,widget_type:"Controller"};this.connection&&this.connection.id?b.connection_id=this.connection.id:l&&(b.connection_id=l);f.logEvent(b)};this.connect=function(b,c,
																																																																																																																																																																																																																																																											e){this.is("connecting","connected")?OT.warn("OT.Session: Cannot connect, the session is already "+this.state):(y.call(this),r("connecting"),d=c,g?g=!1:h=OT.$.uuid(),a=b.toString(),0===OT.APIKEY.length&&(OT.APIKEY=a),e&&OT.$.isFunction(e)&&(this.once(OT.Event.names.SESSION_CONNECTED,e.bind(null,null)),this.once("sessionConnectFailed",e)),this.logEvent("Connect","Attempt","userAgent|sdkVersion|chromeFrame",[navigator.userAgent,OT.properties.version,k.externalHost?"yes":"no"].map(function(a){return a.replace("|",
		"\\|")}).join("|")),E.call(this))};this.disconnect=function(){b&&b.isNot("disconnected")?(r("disconnecting"),b.disconnect()):y.call(this)};this.destroy=function(a,b){this.streams.destroy();this.connections.destroy();this.disconnect()};this.publish=function(c,d,g){if(this.isNot("connected"))return f.logError(1010,"tb.exception","We need to be connected before you can publish",null,{action:"publish",variation:"Failure",payload_type:"reason",payload:"We need to be connected before you can publish",session_id:e,
	partner_id:a,widgetId:h,widget_type:"Controller"}),g&&OT.$.isFunction(g)&&OT.$.callAsync(g,new OT.Error(OT.ExceptionCodes.NOT_CONNECTED,"We need to be connected before you can publish")),null;if(!b||!b.permittedTo("publish"))return this.logEvent("publish","Failure","reason","This token does not allow publishing. The role must be at least `publisher` to enable this functionality"),TB.handleJsException("This token does not allow publishing. The role must be at least `publisher` to enable this functionality",
		OT.ExceptionCodes.UNABLE_TO_PUBLISH,{session:this}),null;if(!c||"string"===typeof c||c.nodeType==Node.ELEMENT_NODE)c=OT.initPublisher(this.apiKey,c,d);else if(c instanceof OT.Publisher)"session"in c&&(c.session&&"sessionId"in c.session)&&(c.session.sessionId===this.sessionId?OT.warn("Cannot publish "+c.guid+" again to "+this.sessionId+". Please call session.unpublish(publisher) first."):OT.warn("Cannot publish "+c.guid+" publisher already attached to "+c.session.sessionId+". Please call session.unpublish(publisher) first."));
else throw c="Session.publish :: First parameter passed in is neither a string nor an instance of the Publisher",OT.error(c),Error(c);if(g&&OT.$.isFunction(g))c.once("publishComplete",g);c._.publishToSession(this);return c};this.unpublish=function(a){a?a._.unpublishFromSession(this):OT.error("OT.Session.unpublish: publisher parameter missing.")};this.subscribe=function(a,b,c,d){if(!this.connection||!this.connection.connectionId)throw a="Session.subscribe :: Connection required to subscribe",OT.error(a),
		Error(a);if(!a)throw a="Session.subscribe :: stream cannot be null",OT.error(a),Error(a);if(!a.hasOwnProperty("streamId"))throw a="Session.subscribe :: invalid stream object",OT.error(a),Error(a);b=new OT.Subscriber(b,OT.$.extend(c||{},{session:this}));if(d&&OT.$.isFunction(d))b.once("subscribeComplete",d);OT.subscribers.add(b);b.subscribe(a);return b};this.unsubscribe=function(a){if(!a)throw OT.error("OT.Session.unsubscribe: subscriber cannot be null"),Error("OT.Session.unsubscribe: subscriber cannot be null");
	if(!a.stream)return OT.warn("OT.Session.unsubscribe:: tried to unsubscribe a subscriber that had no stream"),!1;OT.debug("OT.Session.unsubscribe: subscriber "+a.id);a.destroy();return!0};this.getSubscribersForStream=function(a){return OT.subscribers.where({streamId:a.id})};this.getPublisherForStream=function(a){if("string"!=typeof a)if("object"==typeof a&&a&&a.hasOwnProperty("id"))a=a.id;else throw errorMsg="Session.getPublisherForStream :: Invalid stream type",OT.error(errorMsg),Error(errorMsg);
	return OT.publishers.where({streamId:a})[0]};this._={jsepSubscribe:function(a,c,d){return b.jsepSubscribe(a.connection.id,a.id,c,d)}.bind(this),jsepUnsubscribe:function(a){return b.jsepUnsubscribe(a.connection.id,a.id)}.bind(this),jsepCandidate:function(a,c,d){return b.jsepCandidate(a,c.id,d)}.bind(this),jsepOffer:function(a,c,d){return b.jsepOffer(a,c.id,d)}.bind(this),jsepAnswer:function(a,c,d){return b.jsepAnswer(a,c.id,d)}.bind(this),dispatchSignal:function(a,b,c){a=new OT.SignalEvent(b,c,a);
	a.target=this;this.trigger(OT.Event.names.SIGNAL,a);b&&this.dispatchEvent(a)}.bind(this),modifySubscriber:function(a,c,d){return b.modifySubscriber(a,c,d)}.bind(this),createStream:function(a,c,d,e,f,g,h){b.createStream(a,c,d,e,f,g,h)}.bind(this),modifyStream:function(a,c,d){!a||!c||void 0===d?OT.error("OT.Session.modifyStream: must provide streamId, key and value to modify a stream property."):b.updateStream(a,c,d)}.bind(this),destroyStream:function(a){b.destroyStream(a)}.bind(this)};this.signal=
		function(a,c){b.signal(a,c)};this.forceDisconnect=function(a,d){if(b&&b.permittedTo("forceDisconnect")){var e="string"===typeof a?a:a.id;if(d){var f=new c(this,d,{timeoutMessage:"Timed out while waiting for connection "+e+" to be force Disconnected."});f.failsOnExceptionCodes({1520:"This token does not allow forceDisconnect. The role must be at least `moderator` to enable this functionality"});q[e]=f}b.forceDisconnect(e)}else d&&OT.$.callAsync(d,new OT.Error(null,"This token does not allow forceDisconnect. The role must be at least `moderator` to enable this functionality")),
		TB.handleJsException("This token does not allow forceDisconnect. The role must be at least `moderator` to enable this functionality",OT.ExceptionCodes.UNABLE_TO_FORCE_DISCONNECT,{session:this})};this.forceUnpublish=function(a,d){if(b&&b.permittedTo("forceUnpublish")){var e="string"===typeof a?this.streams.get(a):a;if(d){var f=new c(this,d,{timeoutMessage:"Timed out while waiting for stream "+e.id+" to be force unpublished."});f.failsOnExceptionCodes({1530:"This token does not allow forceUnpublish. The role must be at least `moderator` to enable this functionality"});
	m[e.id]=f}b.forceUnpublish(e.id)}else d&&OT.$.callAsync(d,new OT.Error(null,"This token does not allow forceUnpublish. The role must be at least `moderator` to enable this functionality")),TB.handleJsException("This token does not allow forceUnpublish. The role must be at least `moderator` to enable this functionality",OT.ExceptionCodes.UNABLE_TO_FORCE_UNPUBLISH,{session:this})};this.getStateManager=function(){OT.warn("Fixme: Have not implemented session.getStateManager")};OT.$.defineGetters(this,
		{apiKey:function(){return a},token:function(){return d},connected:function(){return this.is("connected")},connection:function(){return b&&b.id?this.connections.get(b.id):null},capabilities:function(){return b?b.capabilities:new OT.Capabilities([])},sessionId:function(){return e},id:function(){return e}},!0)}else OT.upgradeSystemRequirements()}})(window);(function(k){k=document.createElement("link");k.type="text/css";k.media="screen";k.rel="stylesheet";k.href=OT.properties.cssURL;(document.head||document.getElementsByTagName("head")[0]).appendChild(k)})(window);
(function(k){"function"===typeof define&&define.amd&&define("TB",[],function(){return TB})})(window);