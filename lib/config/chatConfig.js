...
//Export module
	...
	io.sockets.on('connection', function (socket) {
		...
		socket.on('sendchat', function (message) {
			...
			socket.emit('updatechat', socket.userObject.username, message);
			//mensaje de servidor "usuario entró a la sala"
			socket.broadcast.to(socket.userObject.room).emit('updatechat', socket.userObject.username, message);
		});
