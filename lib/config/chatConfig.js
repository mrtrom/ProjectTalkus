	...
	io.sockets.on('connection', function (socket) {
		...
		socket.on('adduser', function(username, tipoSala){
			if (username !== undefined && username !== null && username !== "" &&
				...
				console.log('global: ' + GLOBAL.globalChatUsers);
				...
				if (GLOBAL.globalChatUsers !== null){
					...
					for (var userKey in GLOBAL.globalChatUsers){
						...
						console.log('ser: ' + GLOBAL.globalChatUsers[userKey].username);
					...
					console.log('array: ' +arrayOfKeys.length);
				...
				/*console.log('antes');
				console.log(GLOBAL.globalChatUsers);*/
		...
		socket.on('sendchat', function (message) {
			...
			socket.emit('updatechat', socket.userObject.username, message, 'message', 'me');
			//mensaje de servidor "usuario entró a la sala"
			socket.broadcast.to(socket.userObject.room).emit('updatechat', socket.userObject.username, message, 'message' , 'partner');
		});
